...
namespace FdoToolbox.Lib
{
    ...
    internal class HostApplication : BaseApplication, IHostApplication
    {
        ...
        {
            TaskLoader.DbConnectionLoaded += new DbConnectionLoadedEventHandler(TaskLoader_DbConnectionLoaded);
            TaskLoader.FdoConnectionLoaded += new FdoConnectionLoadedEventHandler(TaskLoader_FdoConnectionLoaded);
            TaskLoader.GetUniqueFdoName += new UniqueNameDelegate(TaskLoader_GetUniqueFdoName);
            TaskLoader.RemoveDbConnection += new RemoveDbConnectionEventHandler(TaskLoader_RemoveDbConnection);
            TaskLoader.RemoveFdoConnection += new RemoveFdoConnectionEventHandler(TaskLoader_RemoveFdoConnection);
        }
        ...
        {
            this.DatabaseConnectionManager.RemoveConnection(e.Data);
        }
