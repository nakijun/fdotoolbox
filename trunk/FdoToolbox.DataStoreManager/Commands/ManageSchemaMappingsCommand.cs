...
using FdoToolbox.OverrideManager.Controls;
using FdoToolbox.Base;

namespace FdoToolbox.OverrideManager.Commands
{
    public class ManageSchemaMappingsCommand : AbstractMenuCommand
    {
        public override void Run()
        {
            ...
            if (conn != null)
            {
                FdoSchemaOverrideMgr ctl = new FdoSchemaOverrideMgr(conn);
