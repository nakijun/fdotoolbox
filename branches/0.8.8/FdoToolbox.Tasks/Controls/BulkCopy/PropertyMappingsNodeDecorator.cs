...
namespace FdoToolbox.Tasks.Controls.BulkCopy
{
    ...
    internal class PropertyMappingsNodeDecorator
    {
        ...
        internal PropertyMappingsNodeDecorator(CopyTaskNodeDecorator parent, TreeNode mappingsNode)
        {
            ...
            _selectedPropertyMenu = BuildSelectedPropertyContextMenu(Parent.TargetClass, OnMapProperty, OnRemovePropertyMapping);
        ...
        private void OnMapProperty(object sender, EventArgs e)
        {
            ...
            try
            {
                this.MapProperty(propertyNode.Name, itm.Tag.ToString());
            }
        ...
        private static ContextMenuStrip BuildSelectedPropertyContextMenu(ClassDefinition cd, EventHandler mapHandler, EventHandler removeMappingHandler)
        {
        ...
        public void MapProperty(string propertyName, string destProperty)
        {
            PropertyDefinition src = Parent.SourceClass.Properties[propertyName];
            PropertyDefinition dst = Parent.TargetClass.Properties[destProperty];
