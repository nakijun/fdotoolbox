...
namespace TestLibrary
{
    ...
    {
        public static void EqualSchemas(FeatureService service, FeatureSchema schema, FeatureSchema fs)
        {
            Assert.AreEqual(schema.Name, fs.Name);
            Assert.AreEqual(schema.Classes.Count, fs.Classes.Count);

            foreach (ClassDefinition classDef in schema.Classes)
            {
                ClassDefinition cd = service.GetClassByName(schema.Name, classDef.Name);
