...
namespace FdoInfo
{
    public class GetDestroyDataStoreParametersCommand : ConsoleCommand
    {
        ...
        public override int Execute()
        {
            ...
            {
                AppConsole.Err.WriteLine("This provider does not support destroying data stores");
            ...
            using (IDestroyDataStore destroy = conn.CreateCommand(OSGeo.FDO.Commands.CommandType.CommandType_DestroyDataStore) as IDestroyDataStore)
            {
                ...
                AppConsole.WriteLine("Data Store Properties:");
