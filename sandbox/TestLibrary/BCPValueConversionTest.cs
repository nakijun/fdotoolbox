...
/**
 * Some assertions have been commented out as there is a precision issue.
 * 
 * Why isn't there an Assert.AreApproximatelyEqual(T1, T2) where 
 *  T1: float, double, decimal 
 *  T2: float, double, decimal
 */
...
namespace FdoToolbox.Tests
{
    ...
    public class BCPValueConversionTest : BaseTest
    {
